    ...
    <div class="theme_option_field_ac_content">
     ...
     <div class="sub_box">
      ...
      <div class="sub_box_content">
       ...
       <p><input class="full_width" type="text" class="theme_option_subbox_headline_label regular-text" name="dp_options[pw_name<?php echo $i; ?>]" value="<?php echo esc_attr( $options['pw_name' . $i] ); ?>"></label></p>
       ...
       <ul class="option_list">
        ...
        <li class="cf button_option">
         ...
         <div class="admin_link_option">
          <input type="text" name="dp_options[pw_btn_url<?php echo $i; ?>]" placeholder="https://example.com/" value="<?php esc_attr_e( $options['pw_btn_url'.$i] ); ?>">
          <input id="pw_btn_target<?php echo $i; ?>" class="admin_link_option_target" name="dp_options[pw_btn_target<?php echo $i; ?>]" type="checkbox" value="1" <?php checked( $options['pw_btn_target'.$i], 1 ); ?>>
          <label for="pw_btn_target<?php echo $i; ?>">&#xe92a;</label>
         </div>
        </li>
        <li class="cf"><span class="label"><?php _e('Direction', 'tcd-w'); ?></span><?php echo tcd_basic_radio_button($options, 'pw_direction'.$i, $content_direction_options); ?></li>
       </ul>
