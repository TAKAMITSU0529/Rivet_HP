...
$load_screen_options = array(
 ...
 'type4' => array('value' => 'type4','label' => __( 'Display once at first time access', 'tcd-w' ))
);
...
// ツイッターのサムネイルサイズ
global $twitter_image_options;
$twitter_image_options = array(
  'summary' => array('value' => 'summary','label' => __( 'Normal', 'tcd-w' )),
  'summary_large_image' => array('value' => 'summary_large_image','label' => __( 'Largish', 'tcd-w' ))
);
