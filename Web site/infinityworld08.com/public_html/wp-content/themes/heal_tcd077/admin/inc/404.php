...
<div id="tab-content-basic" class="tab-content">
   ...
   <div class="theme_option_field cf theme_option_field_ac open active">
    <h3 class="theme_option_headline"><?php _e( '404 page', 'tcd-w' ); ?></h3>
    <div class="theme_option_field_ac_content">

     <h4 class="theme_option_headline2"><?php _e( 'Headline', 'tcd-w' ); ?></h4>
     <textarea class="full_width" cols="50" rows="2" name="dp_options[header_txt_404]"><?php echo esc_textarea( $options['header_txt_404'] ); ?></textarea>
     <ul class="option_list">
      <li class="cf"><span class="label"><?php _e('Font size', 'tcd-w'); ?></span><?php echo tcd_font_size_option($options, 'header_txt_size_404'); ?></li>
     ...
     <ul class="option_list">
      <li class="cf"><span class="label"><?php _e('Dropshadow position (left)', 'tcd-w'); ?></span><input id="dp_options[dropshadow_404_h]" class="font_size hankaku" type="text" name="dp_options[dropshadow_404_h]" value="<?php echo esc_attr( $options['dropshadow_404_h'] ); ?>"><span>px</span></li>
      <li class="cf"><span class="label"><?php _e('Dropshadow position (top)', 'tcd-w'); ?></span><input id="dp_options[dropshadow_404_v]" class="font_size hankaku" type="text" name="dp_options[dropshadow_404_v]" value="<?php echo esc_attr( $options['dropshadow_404_v'] ); ?>"><span>px</span></li>
      <li class="cf"><span class="label"><?php _e('Dropshadow size', 'tcd-w'); ?></span><input id="dp_options[dropshadow_404_b]" class="font_size hankaku" type="text" name="dp_options[dropshadow_404_b]" value="<?php echo esc_attr( $options['dropshadow_404_b'] ); ?>"><span>px</span></li>
     ...
     <ul class="option_list">
      <li class="cf"><span class="label"><?php _e('Font size', 'tcd-w'); ?></span><?php echo tcd_font_size_option($options, 'header_sub_txt_size_404'); ?></li>
      <li class="cf"><span class="label"><?php _e('Font color', 'tcd-w'); ?></span><input type="text" name="dp_options[header_txt_color_404]" value="<?php echo esc_attr( $options['header_txt_color_404'] ); ?>" data-default-color="#ffffff" class="c-color-picker"></li>
     </ul>
     ...
     <div style="<?php if($options['use_overlay_404'] == 1) { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">
      <ul class="option_list" style="border-top:1px dotted #ccc; padding-top:12px;">
       <li class="cf"><span class="label"><?php _e('Color of overlay', 'tcd-w'); ?></span><input type="text" name="dp_options[overlay_color_404]" value="<?php echo esc_attr( $options['overlay_color_404'] ); ?>" data-default-color="#000000" class="c-color-picker"></li>
       <li class="cf">
...
function add_404_theme_options_validate( $input ) {
  ...
  if ( ! isset( $input['use_overlay_404'] ) )
    $input['use_overlay_404'] = null;
    $input['use_overlay_404'] = ( $input['use_overlay_404'] == 1 ? 1 : 0 );
