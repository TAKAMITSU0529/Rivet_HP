...
function custom_script_meta_box() {
  $post_types = array ( 'post', 'page', 'news', 'menu', 'staff', 'campaign');
  add_meta_box(
...
<div class="tcd_custom_fields">
 ...
 <div class="tcd_cf_content">
  ...
  <textarea id="custom_css" class="full_width" cols="50" rows="5" name="custom_css"><?php if(!empty($custom_css)){ echo esc_textarea($custom_css); }; ?></textarea>
 </div><!-- END .content -->
 ...
 <div class="tcd_cf_content">
  ...
  <textarea id="custom_script" class="full_width" cols="50" rows="5" name="custom_script"><?php if(!empty($custom_script)){ echo esc_textarea($custom_script); }; ?></textarea>
 </div><!-- END .content -->
 ...
 <div class="tcd_cf_content">
  ...
  <textarea id="footer_custom_script" class="full_width" cols="50" rows="5" name="footer_custom_script"><?php if(!empty($footer_custom_script)){ echo esc_textarea($footer_custom_script); }; ?></textarea>
 </div><!-- END .content -->
