...
function get_latest_theme_version( $interval ) {
    ...
    $notifier_file_url = 'http://design-plus1.com/notifier_heal.xml';
    $db_cache_field = 'heal-contempo-notifier-cache';
    $db_cache_field_last_updated = 'heal-contempo-notifier-last-updated';
