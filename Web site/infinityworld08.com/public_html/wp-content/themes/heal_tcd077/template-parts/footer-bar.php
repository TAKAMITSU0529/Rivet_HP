...
<?php if($value['icon'] == 'material_icon' && $value['material_icon']){ ?>
			<span class="dp-footer-bar-icon google_material_icon"><span class="icon">&#x<?php echo $value['material_icon']; ?>;</span><span class="label"><?php echo esc_html( $value['label'] ); ?></span></span>
<?php } else { ?>
...
<div id="modal-content" class="modal-content hide">
	<ul class="share clearfix">
		...
		<li class="share-button">
			<a href="https://b.hatena.ne.jp/entry/" class="hatena-bookmark-button" data-hatena-bookmark-layout="simple" data-hatena-bookmark-width="50" data-hatena-bookmark-height="50" title="このエントリーをはてなブックマークに追加"><img src="<?php echo get_template_directory_uri(); ?>/img/common/hatena.png" alt="このエントリーをはてなブックマークに追加" width="20" height="20" style="border: none;" /></a><script type="text/javascript" src="https://b.st-hatena.com/js/bookmark_button.js" charset="utf-8" async="async"></script>
		</li>
	</ul>
</div>
