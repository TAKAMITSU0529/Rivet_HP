...
body.end_loading #site_loader_overlay { opacity:0; transition: opacity 1.5s ease 0.6s; }
body.end_loading #site_loader_overlay > * { opacity:0 !important; transition: opacity 0.5s ease 0.3s !important; }
<?php
...
@media screen and (max-width:800px) {
  ...
  #loader_catch .pc { display:none; }
  #loader_catch .sp { display:block; }
}
<?php // ロゴ ?>
#loader_logo_image { opacity:0; display:flex; flex-wrap:wrap; justify-content:center; align-items:center; width:100%; height:100%; }
#site_loader_overlay.active #loader_logo_image { opacity:1; transition: opacity 1.4s ease 1.5s; }
#loader_logo_image img { display:block; margin:auto; max-width:calc(100% - 100px); height:auto; }
...
#site_loader_overlay #loader_logo_image + #loader_catch { margin-top:50px; }
<?php // キャッチフレーズ ?>
#loader_catch { opacity:0; line-height:1.5; font-size:<?php echo esc_html($loading_catch_font_size); ?>px; color:<?php echo esc_html($options['loading_catch_font_color']); ?>; }
