...
function tcd_add_quicktags() {
	...
	$tcdQuicktagsL10n = array(
		'pulldown_title' => array(
			'display' => __( 'quicktags', 'tcd-canon' ),
		),
		'ytube' => array(
			'display' => __( 'YouTube', 'tcd-canon' ),
			'tag' => __( '<div class="ytube">YouTube code here</div>', 'tcd-canon' )
		),
		'relatedcardlink' => array(
			'display' => __( 'Cardlink', 'tcd-canon' ),
			'tag' => __( '[clink url="Post URL to display"]', 'tcd-canon' )
		),
		'post_col-2' => array(
			'display' => __( '2 column', 'tcd-canon' ),
			'tag' => __( "<div class='post_row'>\n<div class='post_col post_col-2'>\nText and image tags to display in the left column\n</div>\n<div class='post_col post_col-2'>\nText and image tags to display in the right column\n</div>\n</div>", 'tcd-canon' )
		),
		'post_col-3' => array(
			'display' => __( '3 column', 'tcd-canon' ),
			'tag' => __( "<div class='post_row'>\n<div class='post_col post_col-3'>\nText and image tags to display in the left column\n</div>\n<div class='post_col post_col-3'>\nText and image tags to display in the center column\n</div>\n<div class='post_col post_col-3'>\nText and image tags to display in the right column\n</div>\n</div>", 'tcd-canon' )
		),
		'q_comment_out' => array(
			'display' => __( 'Comment out', 'tcd-canon' ),
			'tagStart' => '<div class="hidden"><!-- ',
			'tagEnd' => ' --></div>'
		),
		'q_h2' => array(
			'display' => __( 'Styled h2 tag', 'tcd-canon' ),
			'tagStart' => '<h2 class="styled_h2">',
			'tagEnd' => '</h2>'
		),
		'q_h3' => array(
			'display' => __( 'Styled h3 tag', 'tcd-canon' ),
			'tagStart' => '<h3 class="styled_h3">',
			'tagEnd' => '</h3>'
		),
		'q_h4' => array(
			'display' => __( 'Styled h4 tag', 'tcd-canon' ),
			'tagStart' => '<h4 class="styled_h4">',
			'tagEnd' => '</h4>'
		),
		'q_h5' => array(
			'display' => __( 'Styled h5 tag', 'tcd-canon' ),
			'tagStart' => '<h5 class="styled_h5">',
			'tagEnd' => '</h5>'
		),
		'q_ol' => array(
			'display' => __( 'Styled ol', 'tcd-canon' ),
			'tag' => '<ol class="q_styled_ol">'."\n".'<li>'.__('List', 'tcd-canon').'1</li>'."\n".'<li>'.__('List', 'tcd-canon').'2</li>'."\n".'<li>'.__('List', 'tcd-canon').'3</li>'."\n".'</ol>'
		),
		'gray_bg' => array(
			'display' => __( 'Gray background', 'tcd-canon' ),
			'tag' => "<div class='gray_bg'>\n\n" . __('Enter content here', 'tcd-canon') . "\n\n</div>",
		),
		'q_frame1' => array(
			'display' => __( 'Frame style', 'tcd-canon' ).'1',
			'tagStart' => '<div class="q_frame q_frame1"><span class="q_frame_label">'.esc_html($dp_options['qt_frame1_label']).'</span>',
			'tagEnd' => '</div>'
		),
		'q_frame2' => array(
			'display' => __( 'Frame style', 'tcd-canon' ).'2',
			'tagStart' => '<div class="q_frame q_frame2"><span class="q_frame_label">'.esc_html($dp_options['qt_frame2_label']).'</span>',
			'tagEnd' => '</div>'
		),
		'q_frame3' => array(
			'display' => __( 'Frame style', 'tcd-canon' ).'3',
			'tagStart' => '<div class="q_frame q_frame3"><span class="q_frame_label">'.esc_html($dp_options['qt_frame3_label']).'</span>',
			'tagEnd' => '</div>'
		),
		'design_button' => array(
			'display' => __( 'Design button', 'tcd-canon' ),
			'tag' => '<a href="#" class="design_button">' . __( 'Design button', 'tcd-canon' ) . '</a>'
		),
		'q_custom_button1' => array(
			'display' => sprintf( __( 'Button %d', 'tcd-canon' ), 1 ),
			'tag' => '<div class="q_button_wrap"><a href="#" class="q_custom_button q_custom_button1">' . sprintf( __( 'Button %d', 'tcd-canon' ), 1 ) . '</a></div>'
		),
		'q_custom_button2' => array(
			'display' => sprintf( __( 'Button %d', 'tcd-canon' ), 2 ),
			'tag' => '<div class="q_button_wrap"><a href="#" class="q_custom_button q_custom_button2">' . sprintf( __( 'Button %d', 'tcd-canon' ), 2 ) . '</a></div>'
		),
		'q_custom_button3' => array(
			'display' => sprintf( __( 'Button %d', 'tcd-canon' ), 3 ),
			'tag' => '<div class="q_button_wrap"><a href="#" class="q_custom_button q_custom_button3">' . sprintf( __( 'Button %d', 'tcd-canon' ), 3 ) . '</a></div>'
		),
		'q_underline1' => array(
			'display' => sprintf( __( 'Underline %d', 'tcd-canon' ), 1 ),
			'tagStart' => '<span class="q_underline q_underline1" style="border-bottom-color:;">',
			'tagEnd' => '</span>'
		),
		'q_underline2' => array(
			'display' => sprintf( __( 'Underline %d', 'tcd-canon' ), 2 ),
			'tagStart' => '<span class="q_underline q_underline2" style="border-bottom-color:;">',
			'tagEnd' => '</span>'
		),
		'q_underline3' => array(
			'display' => sprintf( __( 'Underline %d', 'tcd-canon' ), 3 ),
			'tagStart' => '<span class="q_underline q_underline3" style="border-bottom-color:;">',
			'tagEnd' => '</span>'
		),
		'speech_balloon_left1' => array(
			'display' => __( 'Speech balloon left 1', 'tcd-canon' ),
			'tagStart' => '[speech_balloon_left1]',
			'tagEnd' => '[/speech_balloon_left1]'
		),
		'speech_balloon_left2' => array(
			'display' => __( 'Speech balloon left 2', 'tcd-canon' ),
			'tagStart' => '[speech_balloon_left2]',
			'tagEnd' => '[/speech_balloon_left2]'
		),
		'speech_balloon_right1' => array(
			'display' => __( 'Speech balloon right 1', 'tcd-canon' ),
			'tagStart' => '[speech_balloon_right1]',
			'tagEnd' => '[/speech_balloon_right1]'
		),
		'speech_balloon_right2' => array(
			'display' => __( 'Speech balloon right 2', 'tcd-canon' ),
			'tagStart' => '[speech_balloon_right2]',
			'tagEnd' => '[/speech_balloon_right2]'
		),
		'google_map' => array(
			'display' => __( 'Google Maps', 'tcd-canon' ),
			'tag' => '[qt_google_map address="'. __( 'Enter address here', 'tcd-canon' ) . '"]'
		),
		'tab_content' => array(
			'display' => __( 'Tab content', 'tcd-canon' ),
			'tag' => '[tcd_tab tab1="'. __( 'Tab1 headline', 'tcd-canon' ) . '" img1="'. __( 'Enter tab1 image url here', 'tcd-canon' ) . '" tab2="'. __( 'Tab2 headline', 'tcd-canon' ) . '" img2="'. __( 'Enter tab2 image url here', 'tcd-canon' ) . '"]'
		),
		'design_headline1' => array(
			'display' => __( 'Design headline1', 'tcd-canon' ),
			'tagStart' => '<h2 class="design_headline1">',
			'tagEnd' => '</h2>'
		),
		'design_headline2' => array(
			'display' => __( 'Design headline2', 'tcd-canon' ),
			'tagStart' => '<h3 class="design_headline2 inview">',
			'tagEnd' => '</h3>'
		),
		'design_headline3' => array(
			'display' => __( 'Design headline3', 'tcd-canon' ),
			'tag' => '<h4 class="design_headline3"><span class="title">' . __( 'Title', 'tcd-canon' ) . '</span><span class="sub_title">'.  __( 'Subtitle', 'tcd-canon' ). '</span></h4>'
		),
...
@font-face {
  ...
  font-style: normal;
  font-display:swap;
  src: url('<?php echo esc_url(get_template_directory_uri()); ?>/fonts/normal_icon.woff?v=1.1') format('woff');
}
body#tinymce, .mce-content-body, .wp-block-post-content { /* 注意：入れ子にしないと管理画面内の全ての要素に適用される */
...
body#tinymce, .mce-content-body, .wp-block-post-content {
...
<?php
     ...
     } elseif($dp_options['catch_font_type'] == 'type2'){
     ...
     } elseif($dp_options['content_font_type'] == 'type2'){
...
?>
h1 { font-size:36px; font-weight:500; line-height:1.4; margin: 120px 0 30px 0; text-align:center; }
h2 { font-size:30px; font-weight:500; line-height:1.4; margin: 40px 0 30px 0; text-align:center; }
h3 { font-size:28px; font-weight:500; line-height:1.6; margin: 40px 0 30px 0; }
h4 { font-size:24px; font-weight:500; line-height:1.6; margin: 2.3em 0 1em 0; }
h5 { font-size:22px; font-weight:500; line-height:1.6; margin: 2.3em 0 1em 0; }
h6 { font-size:20px; font-weight:500; line-height:1.6; margin: 2.3em 0 1em 0; }
...
/* 空タグ、スペース */
.q_button_wrap { margin-top:60px; margin-bottom:55px; }
p + .q_button_wrap { margin-top:55px; }


/* デザイン見出し1 */
.design_headline1 { text-align:center; font-size:38px !important; margin:73px 0 40px 0; margin-bottom:40px !important; font-family:<?php echo wp_kses_post($catch_font_type); ?>; }
.design_headline1 + p { margin-top:-7px; }
.design_headline1 + img { margin-top:110px; }
.post_row + .design_headline1 { margin-top:110px; }
.design_headline1:first-child { margin-top:-5px !important; }


/* デザイン見出し2 */
.design_headline2 { font-size:26px !important; display:table; margin:115px auto 80px; padding:0 0 25px 0; font-family:<?php echo wp_kses_post($catch_font_type); ?>; border-bottom:5px solid #000; }


/* デザイン見出し3 */
.design_headline3 { font-size:34px !important; margin:45px 0 35px 0 !important; padding:0 !important; line-height:1 !important; display:flex; flex-wrap:nowrap; align-items:center; font-family:<?php echo wp_kses_post($catch_font_type); ?>; }
.design_headline3 .sub_title { flex: 0 0 auto; font-size:16px; margin:0 0 0 20px; font-family:<?php echo wp_kses_post($content_font_type); ?>; }


/* デザインボタン */
a.design_button {
  min-width:280px; height:70px; line-height:1.5; padding:0 1.5em; text-align:center; position:relative; overflow:hidden; font-size:16px; z-index:1; color:#fff !important; border:1px solid <?php echo esc_attr($dp_options['main_color']); ?>; background:<?php echo esc_attr($dp_options['main_color']); ?>; text-decoration: none;
...
.aligncenter { display:block; margin-left:auto; margin-right:auto; margin-bottom:7px; text-align:center; }
...
/* text and headline */
p { line-height:2.4; margin-bottom:2em; }
...
ul, ol, dl { margin-bottom:2em; padding:0; }
...
/* table */
table { margin-bottom:50px; width:100% !important; border-collapse:collapse !important; }
td, th { border:1px solid #ddd; padding:18px 30px 16px; line-height:2.2; background:#fff; }
...
/* captions */
.wp-caption { margin-bottom:50px; background:#fff; border:1px solid #ddd; padding:10px; max-width:100%; }
...
/* クイックタグのデザインボタン */
.q_button_wrap { text-align:center; }
...
/* ブロックエディタ */
.wp-block-freeform.block-library-rich-text__tinymce p { line-height:2.4; }
...
.wp-block-table { overflow:visible !important; }
...
?>
.styled_h<?php echo $i ?>, .mce-content-body, .wp-block-post-content .styled_h<?php echo $i ?> {
