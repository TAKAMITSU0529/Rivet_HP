...
function gallery_meta_box() {
  ...
  add_meta_box(
    ...
    sprintf(__('%s information', 'tcd-canon'), $gallery_label),//label
...
add_action('add_meta_boxes', 'gallery_meta_box', 998);
...
<div class="tcd_custom_field_wrap">
  ...
  <div class="theme_option_field cf theme_option_field_ac">
   ...
   <div class="theme_option_field_ac_content">
    ...
    <div class="cb_image">
     <img src="<?php bloginfo('template_url'); ?>/admin/img/image/gallery_single.jpg" width="" height="" />
    </div>

    <ul class="option_list">
     <li class="cf"><span class="label"><span class="num">1</span><?php _e('Catchphrase', 'tcd-canon'); ?></span><input type="text" class="full_width" name="gallery_catch" value="<?php echo esc_attr($gallery_catch); ?>" /></li>
     <li class="cf"><span class="label"><span class="num">2</span><?php _e('Button label', 'tcd-canon'); ?></span><input type="text" class="full_width" name="gallery_button_label" value="<?php echo esc_attr($gallery_button_label); ?>" /></li>
     <li class="cf space">
      <span class="label"><?php _e('URL', 'tcd-canon'); ?></span>
      <div class="admin_link_option">
       <input type="text" name="gallery_button_url" placeholder="https://example.com/" value="<?php echo esc_url($gallery_button_url); ?>">
       <input id="gallery_button_target" class="admin_link_option_target" name="gallery_button_target" type="checkbox" value="1" <?php checked( $gallery_button_target, 1 ); ?>>
       <label for="gallery_button_target">&#xe920;</label>
      </div>
     </li>
     <li class="cf"><span class="label"><span class="num">3</span><?php _e('Spec', 'tcd-canon'); ?>1</span><input type="text" class="full_width" name="gallery_spec1" value="<?php echo esc_attr($gallery_spec1); ?>" /></li>
     <li class="cf space"><span class="label"><?php _e('Spec', 'tcd-canon'); ?>2</span><input type="text" class="full_width" name="gallery_spec2" value="<?php echo esc_attr($gallery_spec2); ?>" /></li>
     <li class="cf space"><span class="label"><?php _e('Spec', 'tcd-canon'); ?>3</span><input type="text" class="full_width" name="gallery_spec3" value="<?php echo esc_attr($gallery_spec3); ?>" /></li>
     <li class="cf space"><span class="label"><?php _e('Spec', 'tcd-canon'); ?>4</span><input type="text" class="full_width" name="gallery_spec4" value="<?php echo esc_attr($gallery_spec4); ?>" /></li>
    </ul>
    ...
    <div class="theme_option_message2" style="margin-top:20px;">
     <p><?php printf(__('%1$s post to be displayed in this %2$s page can be set on the <a href="./edit.php" target="_blank">edit screen</a> for each %3$s post.<br>If the article is not set, it will not be displayed.', 'tcd-canon'), $blog_label, $gallery_label, $blog_label); ?></p>
    </div>
...
function save_gallery_meta_box( $post_id ) {
  ...
  // save or delete
  $cf_keys = array(
    'gallery_catch','gallery_spec1','gallery_spec2','gallery_spec3','gallery_spec4','gallery_button_label','gallery_button_url','gallery_button_target',
    'image_slider','image_slider_type',
