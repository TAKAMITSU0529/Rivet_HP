...
<div class="custom_category_meta" style="margin:20px 0;">
 <h3 class="ccm_headline"><?php _e( 'Additional user data', 'tcd-canon' ); ?></h3>

 <div class="ccm_content tab_parent">

  <?php // 共通設定 ----------------------- ?>
  <ul class="option_list" style="margin-bottom:30px;">
   <li class="cf">
    <span class="label"><?php _e('Profile in blog page', 'tcd-canon'); ?></span>
    <div class="standard_radio_button">
     <input id="show_author_yes" type="radio" name="show_author" value="1" <?php checked( $show_author, '1' ); ?>>
     <label for="show_author_yes"><?php _e('Display', 'tcd-canon'); ?></label>
     <input id="show_author_no" type="radio" name="show_author" value="2" <?php checked( $show_author, '2' ); ?>>
     <label for="show_author_no"><?php _e('Hide', 'tcd-canon'); ?></label>
    </div>
   </li>
   <li class="cf">
    <span class="label">
     <?php _e('Profile image', 'tcd-canon'); ?>
   ...
   <li class="cf">
    <span class="label">LINE URL</span>
    <input type="text" name="line_url" value="<?php echo esc_attr( get_the_author_meta( 'line_url', $user->ID ) ); ?>" class="full_width" />
   </li>
   <li class="cf">
    <span class="label">Instagram URL</span>
    <input type="text" name="instagram_url" value="<?php echo esc_attr( get_the_author_meta( 'instagram_url', $user->ID ) ); ?>" class="full_width" />
   </li>
   <li class="cf">
    <span class="label">TikTok URL</span>
    <input type="text" name="tiktok_url" value="<?php echo esc_attr( get_the_author_meta( 'tiktok_url', $user->ID ) ); ?>" class="full_width" />
   </li>
   <li class="cf">
    <span class="label">X URL</span>
    <input type="text" name="twitter_url" value="<?php echo esc_attr( get_the_author_meta( 'twitter_url', $user->ID ) ); ?>" class="full_width" />
   </li>
   <li class="cf">
    <span class="label">Facebook URL</span>
    <input type="text" name="facebook_url" value="<?php echo esc_attr( get_the_author_meta( 'facebook_url', $user->ID ) ); ?>" class="full_width" />
   </li>
   <li class="cf">
    <span class="label">Pinterest URL</span>
    <input type="text" name="pinterest_url" value="<?php echo esc_attr( get_the_author_meta( 'pinterest_url', $user->ID ) ); ?>" class="full_width" />
   </li>
   <li class="cf">
    <span class="label">YouTube URL</span>
    <input type="text" name="youtube_url" value="<?php echo esc_attr( get_the_author_meta( 'youtube_url', $user->ID ) ); ?>" class="full_width" />
   </li>
   <li class="cf">
    <span class="label"><?php _e('Contact page URL<br>(You can use mailto:)', 'tcd-canon'); ?></span>
    <input type="text" name="contact_url" value="<?php echo esc_attr( get_the_author_meta( 'contact_url', $user->ID ) ); ?>" class="full_width" />
   </li>
  </ul>
