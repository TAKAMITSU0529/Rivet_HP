...
<div id="site_loader_overlay">
 <div class="content">
  ...
  <p id="loader_catch" class="rich_font_<?php echo esc_attr($options['loading_catch_font_type']); ?>">
    <span class="<?php if($options['loading_catch_sp']){ echo 'pc'; }; ?>"><?php echo wp_kses_post(nl2br($options['loading_catch'])); ?></span>
    <?php if($options['loading_catch_sp']){ ?>
    <span class="sp"><?php echo wp_kses_post(nl2br($options['loading_catch_sp'])); ?></span>
    <?php }; ?>
  </p>
  <?php }; ?>
 </div>
