...
function recommend_post_meta_box() {
 add_meta_box(
  'wp_recommend_post',//ID of meta box
  __('Recommend post', 'tcd-canon'),//label
  'recommend_post',//callback function
  'post',// post type
  'side'
 );
}
add_action('add_meta_boxes', 'recommend_post_meta_box');
...
<div class="theme_option_message2" style="margin-top:15px;">
 <p><?php _e('This option is used in widget, and post carousel that appears on various pages.', 'tcd-canon');  ?></p>
</div>
<ul>
 <li><label><input type="checkbox" name="recommend_post" value="on" <?php checked( $recommend_post, 'on' ); ?>>  <?php _e('Show this post for recommend post1', 'tcd-canon');  ?></label></li>
 <li><label><input type="checkbox" name="recommend_post2" value="on" <?php checked( $recommend_post2, 'on' ); ?>>  <?php _e('Show this post for recommend post2', 'tcd-canon');  ?></label></li>
 <li><label><input type="checkbox" name="recommend_post3" value="on" <?php checked( $recommend_post3, 'on' ); ?>>  <?php _e('Show this post for recommend post3', 'tcd-canon');  ?></label></li>
</ul>
<?php
}
