...
function custom_quick_edit( $column_name, $post_type ) {
  ...
  if ( $print_nonce ) {
    ...
    // seo
    if ( in_array( $post_type, array( 'post', 'page', 'news', 'service', 'gallery' ) ) ) {
  ...
  <div class="inline-edit-col column-meta-seo">
    <div class="inline-edit-group">
      <label class="inline-edit-tcd-w_meta_title">
        <span class="title"><?php _e('Title tag', 'tcd-canon'); ?></span>
      ...
      <label class="inline-edit-tcd-w_meta_description">
        <span class="title" style="line-height:1.5;"><?php _e('Meta description tag', 'tcd-canon');  ?></span>
...
<fieldset class="inline-edit-col-right">
  <div class="inline-edit-col column-recommend">
    <div class="inline-edit-group">
      <label style="line-height:1.5;"><input type="checkbox" name="recommend_post" value="on" /> <?php _e( 'Show this post for recommend post1', 'tcd-canon' );  ?></label>
      <label style="line-height:1.5;"><input type="checkbox" name="recommend_post2" value="on" /> <?php _e( 'Show this post for recommend post2', 'tcd-canon' );  ?></label>
      <label style="line-height:1.5;"><input type="checkbox" name="recommend_post3" value="on" /> <?php _e( 'Show this post for recommend post3', 'tcd-canon' );  ?></label>
    </div>
  </div>
</fieldset>
<?php
...
function custom_quick_edit_values( $actions, $post ) {
  ...
  // seo
  if ( in_array( $post->post_type, array( 'post', 'page', 'news', 'service', 'gallery' ) ) ) {
