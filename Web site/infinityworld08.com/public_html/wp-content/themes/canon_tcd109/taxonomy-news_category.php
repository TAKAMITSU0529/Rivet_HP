<?php
     ...
     $image = $options['archive_news_header_image'];
...
<section id="archive_news">
 ...
 <?php
      ...
      if($options['archive_news_show_category_list'] == 'display'){
        ...
        $children_category = get_term_children($current_cat_id, 'news_category');
        if(empty($children_category)){
          $ancestors = get_ancestors($current_cat_id, 'news_category');
          if ($ancestors) {
        ...
        $category = get_terms( 'news_category', array('parent' => $ancestor_id, 'hide_empty' => true) );
        if ($category) {
 ...
 <div class="category_sort_button_wrap inview<?php if($total_category < 6){ echo ' small_size'; }; ?>">
  <div class="category_sort_button_slider swiper">
   <div class="category_sort_button swiper-wrapper">
    ...
    ?>
    <div class="item swiper-slide<?php if($cat_id == $current_cat_id){ echo ' active_menu'; }; ?>">
   ...
   <div class="content">
    ...
    <div class="category">
     <?php
          ...
          $cat_url = get_term_link($current_cat_id,'news_category');
     ?>
