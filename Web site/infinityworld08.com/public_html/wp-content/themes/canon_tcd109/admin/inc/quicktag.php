...
function add_quicktag_tab_label( $tab_labels ) {
	$tab_labels['quicktag'] = __( 'Quick tag', 'tcd-canon' );
	return $tab_labels;
}
...
function add_quicktag_dp_default_options( $dp_default_options ) {
  ...
  $dp_default_options['qt_speech_balloon1_user_image'] = '';
	$dp_default_options['qt_speech_balloon1_user_name'] = __('User name', 'tcd-canon');
  ...
  // 吹き出し2
	...
	$dp_default_options['qt_speech_balloon2_user_name'] = __('User name', 'tcd-canon');
  ...
  // 吹き出し3
	...
	$dp_default_options['qt_speech_balloon3_user_name'] = __('User name', 'tcd-canon');
  ...
  // 吹き出し4
	...
	$dp_default_options['qt_speech_balloon4_user_name'] = __('User name', 'tcd-canon');
...
<div id="tab-content-quicktag" class="tab-content">
   ...
   <div class="theme_option_field cf theme_option_field_ac active open custon_post_usage_option">
    ...
    <div class="theme_option_field_ac_content">
     ...
     <div class="theme_option_message2">
      <p><?php _e( 'If you don\'t want to use quicktags included in the theme, please uncheck the box below.', 'tcd-canon' ); ?></p>
     </div>
     <p><label><input name="dp_options[use_quicktags]" type="checkbox" value="1" <?php checked( 1, $options['use_quicktags'] ); ?>><?php _e( 'Use quicktags', 'tcd-canon' ); ?></label></p>
   ...
   <div class="theme_option_field cf theme_option_field_ac">
    ...
    <div class="theme_option_field_ac_content">
     ...
     <div class="theme_option_message2">
      <p><?php _e( 'These settings will be reflected in the quick tag button on the edit screen.', 'tcd-canon' ); ?></p>
     </div>

     <?php for ( $i = 2; $i <= 5; $i++ ) : ?>
     <div class="sub_box cf qt-hn-preview-wrapper">
      <h3 class="theme_option_subbox_headline"><?php printf( __( 'H%d tag', 'tcd-canon' ), $i ); ?></h3>
      <div class="sub_box_content">

       <?php // 見出しのプレビュー ?>
       <div class="admin_preview_area qt-hn-preview">
        <div class="qt_heading"><span><?php _e('Headline design', 'tcd-canon'); ?></span></div>
       </div>
       ...
       <h4 class="theme_option_headline2"><?php _e( 'Border setting', 'tcd-canon' ); ?></h4>
       <ul class="option_list">
        <li class="cf"><span class="label"><?php _e('Display position', 'tcd-canon'); ?></span>
        ...
        <li class="cf"><span class="label"><?php _e('Border style', 'tcd-canon'); ?></span><?php echo tcd_basic_radio_button($options, 'qt_h'.$i.'_border_style', $border_style_options); ?></li>
        ...
        <li class="cf">
         <span class="label"><?php _e('Border width', 'tcd-canon'); ?></span>
       ...
       <div class="theme_option_message2">
        <p><?php _e( 'If you set the border style to "Double", please set the border width to 3px or more.', 'tcd-canon' ); ?></p>
       </div>
      ...
      <div class="sub_box_content">
       ...
       <div class="admin_preview_area qt-btn-preview">
        <div class="qt_button_wrap">
         <div class="qt_button type1"><span class="text"><?php _e('Normal', 'tcd-canon'); ?></span><span class="background"></span></div>
         <div class="qt_button type2"><span class="text"><?php _e('Ghost', 'tcd-canon'); ?></span><span class="background"></span></div>
         <div class="qt_button type3"><span class="text"><?php _e('Reverse', 'tcd-canon'); ?></span><span class="background"></span></div>
        </div>
       </div>

       <h4 class="theme_option_headline2"><?php _e( 'Basic setting', 'tcd-canon' ); ?></h4>
       <ul class="option_list">
        <li class="cf"><span class="label"><?php _e('Type', 'tcd-canon'); ?></span><?php echo tcd_basic_radio_button($options, 'qt_button'.$i.'_type', $button_type_options); ?></li>
        <li class="cf"><span class="label"><?php _e('Shape', 'tcd-canon'); ?></span><?php echo tcd_basic_radio_button($options, 'qt_button'.$i.'_border_radius', $button_border_radius_options); ?></li>
        <li class="cf"><span class="label"><?php _e('Size', 'tcd-canon'); ?></span><?php echo tcd_basic_radio_button($options, 'qt_button'.$i.'_size', $button_size_options); ?></li>
        <li class="cf"><span class="label"><?php _e('Mouseover animation', 'tcd-canon'); ?></span><?php echo tcd_basic_radio_button($options, 'qt_button'.$i.'_animation_type', $button_animation_options); ?></li>
        <li class="cf"><span class="label"><?php _e('Color scheme', 'tcd-canon'); ?></span><input type="text" name="dp_options[qt_button<?php echo $i; ?>_color]" value="<?php echo esc_attr( $options['qt_button'.$i.'_color'] ); ?>" data-default-color="<?php echo esc_attr($main_color); ?>" class="c-color-picker"></li>
        <li class="cf"><span class="label"><?php _e('Color scheme on mouseover', 'tcd-canon'); ?></span><input type="text" name="dp_options[qt_button<?php echo $i; ?>_color_hover]" value="<?php echo esc_attr( $options['qt_button'.$i.'_color_hover'] ); ?>" data-default-color="<?php echo esc_attr($main_color); ?>" class="c-color-picker"></li>
       </ul>
   ...
   <?php // 囲み枠 --------------------------------------------- ?>
   <div class="theme_option_field cf theme_option_field_ac">
    <h3 class="theme_option_headline"><?php _e('Frame style', 'tcd-canon'); ?></h3>
    <div class="theme_option_field_ac_content">
     ...
     <div class="sub_box cf qt-frame-preview-wrapper">
      <h3 class="theme_option_subbox_headline"><?php echo __('Frame style', 'tcd-canon').$i; ?></h3>
      <div class="sub_box_content">
       ...
       <div class="admin_preview_area qt-frame-preview">
        <div class="qt_frame">
         ...
         <p><?php _e('The frame has the effect of making the text stand out.</br>Labels can be displayed in the upper left corner.', 'tcd-canon'); ?></p>
        </div>
       </div>

       <h4 class="theme_option_headline2"><?php _e('Label', 'tcd-canon'); ?></h4>
       <ul class="option_list">
        <li class="cf"><span class="label"><?php _e('Label', 'tcd-canon'); ?></span><input class="full_width" name="dp_options[qt_frame<?php echo $i; ?>_label]" type="text" value="<?php echo esc_attr( $options['qt_frame'.$i.'_label'] ); ?>"></li>
        <li class="cf"><span class="label"><?php _e('Font color', 'tcd-canon'); ?></span><input type="text" name="dp_options[qt_frame<?php echo $i; ?>_label_color]" value="<?php echo esc_attr( $options['qt_frame'.$i.'_label_color'] ); ?>" data-default-color="#000000" class="c-color-picker"></li>
       </ul>
       <div class="theme_option_message2">
        <p><?php _e( 'Labels can also be changed from the edit screen of each article, and those set individually will take precedence.', 'tcd-canon' ); ?></p>
       </div>

       <h4 class="theme_option_headline2"><?php _e('Basic setting', 'tcd-canon'); ?></h4>
       <ul class="option_list">
        <li class="cf"><span class="label"><?php _e('Background color', 'tcd-canon'); ?></span><input type="text" name="dp_options[qt_frame<?php echo $i; ?>_content_bg_color]" value="<?php echo esc_attr( $options['qt_frame'.$i.'_content_bg_color'] ); ?>" data-default-color="#ffffff" class="c-color-picker"></li>
        <li class="cf"><span class="label"><?php _e('Shape', 'tcd-canon'); ?></span><?php echo tcd_basic_radio_button($options, 'qt_frame'.$i.'_content_shape', $flame_border_radius_options); ?></li>
        <li class="cf">
         <span class="label"><?php _e('Border width', 'tcd-canon'); ?></span>
         <label class="number_option">
        ...
        <li class="cf"><span class="label"><?php _e('Border color', 'tcd-canon'); ?></span><input type="text" name="dp_options[qt_frame<?php echo $i; ?>_content_border_color]" value="<?php echo esc_attr( $options['qt_frame'.$i.'_content_border_color'] ); ?>" data-default-color="#000000" class="c-color-picker"></li>
        <li class="cf"><span class="label"><?php _e('Border style', 'tcd-canon'); ?></span><?php echo tcd_basic_radio_button($options, 'qt_frame'.$i.'_content_border_style', $border_style_options); ?></li>
       </ul>
       <div class="theme_option_message2">
        <p><?php _e( 'If you set the border style to "Double", please set the border width to 3px or more.', 'tcd-canon' ); ?></p>
       </div>
       ...
       <ul class="button_list cf">
        <li><input type="submit" class="button-ml ajax_button" value="<?php _e('Save', 'tcd-canon'); ?>" /></li>
   ...
   <?php // アンダーライン --------------------------------------------- ?>
   <div class="theme_option_field cf theme_option_field_ac">
    <h3 class="theme_option_headline"><?php _e('Underline', 'tcd-canon'); ?></h3>
    <div class="theme_option_field_ac_content">
     ...
     <div class="sub_box cf qt-ul-preview-wrapper">
      <h3 class="theme_option_subbox_headline"><?php echo __('Underline', 'tcd-canon').$i;  ?></h3>
      <div class="sub_box_content">

       <div class="admin_preview_area qt-ul-preview">
        <div>
         <span class="qt_underline inactive"><?php _e('Sample text for underline.', 'tcd-canon'); ?></span>
         <span class="qt_underline active"><?php _e('The animation will be executed when you scroll into the screen.', 'tcd-canon'); ?></span>
        </div>
       </div>

       <h4 class="theme_option_headline2"><?php _e( 'Basic setting', 'tcd-canon' ); ?></h4>
       <ul class="option_list">
        <li class="cf"><span class="label"><?php _e('Line color', 'tcd-canon'); ?></span><input type="text" name="dp_options[qt_underline<?php echo $i; ?>_border_color]" value="<?php echo esc_attr( $options['qt_underline'.$i.'_border_color'] ); ?>" data-default-color="#fff799" class="c-color-picker"></li>
        ...
        <li class="cf"><span class="label"><?php _e('Using animation', 'tcd-canon'); ?></span><?php echo tcd_basic_radio_button($options, 'qt_underline'.$i.'_use_animation', $bool_options); ?></li>
       </ul>
   ...
   <?php // 吹き出し --------------------------------------------- ?>
   <div class="theme_option_field cf theme_option_field_ac">
    <h3 class="theme_option_headline"><?php _e('Speech balloon', 'tcd-canon');  ?></h3>
    <div class="theme_option_field_ac_content">
     ...
     <div class="sub_box cf qt-sb-preview-wrapper preview_image_wrapper">
      ...
      <?php
           if ( 1 === $i ) _e( 'Speech balloon left 1', 'tcd-canon' );
           elseif ( 2 === $i ) _e( 'Speech balloon left 2', 'tcd-canon' );
           elseif ( 3 === $i ) _e( 'Speech balloon right 1', 'tcd-canon' );
           elseif ( 4 === $i ) _e( 'Speech balloon right 2', 'tcd-canon');
      ?>
      </h3>
      <div class="sub_box_content">
       ...
       <div class="admin_preview_area qt-sb-preview">
        <div class="qt_speech_bubble <?php if($i > 2) echo 'right'; ?>">
         ...
         <div class="user">
          ...
          <span class="name"><?php _e('User name', 'tcd-canon'); ?></span>
         </div>
         <div class="content"><span class="before"></span><?php _e('The speech balloon can be set to a user name, image, and color.', 'tcd-canon'); ?><span class="after"></span></div>
        </div>
       </div>

       <h4 class="theme_option_headline2"><?php _e('Basic setting', 'tcd-canon'); ?></h4>
       <ul class="option_list">
        <li class="cf"><span class="label"><?php _e('User name', 'tcd-canon'); ?></span><input class="regular-text" name="dp_options[qt_speech_balloon<?php echo $i; ?>_user_name]" type="text" value="<?php echo esc_attr( $options['qt_speech_balloon'.$i.'_user_name'] ); ?>"></li>
        ...
        <li class="cf"><span class="label"><?php _e( 'User image', 'tcd-canon' ); ?><span class="recommend_desc"><?php printf(__('Recommend image size. Width:%1$spx, Height:%2$spx.', 'tcd-canon'), '80', '80'); ?></span></span><?php echo tcd_media_image_uploader($options, 'qt_speech_balloon'.$i.'_user_image', 'full'); ?></li>
       </ul>
   ...
   <div class="theme_option_field cf theme_option_field_ac qt-gm-preview-wrapper preview_image_wrapper">
    <h3 class="theme_option_headline"><?php _e( 'Google Maps', 'tcd-canon' );  ?></h3>
    <div class="theme_option_field_ac_content">

     <div class="theme_option_message2">
      <p><?php _e('You can set styles of marker in Google Maps using this option.', 'tcd-canon');  ?></p>
     </div>
     ...
     <div id="qt_google_map">
      <div class="admin_preview_area qt-gm-preview">
       <div class="qt_gmap">
        ...
        <span class="marker custom text"><?php _e( 'MAP', 'tcd-canon' ); ?></span>
     ...
     <h4 class="theme_option_headline2"><?php _e( 'Basic setting', 'tcd-canon' ); ?></h4>
     <ul class="option_list">
      <li class="cf"><span class="label"><?php _e('API key', 'tcd-canon'); ?></span><input class="full_width" type="text" name="dp_options[qt_gmap_api_key]" value="<?php echo esc_attr( $options['qt_gmap_api_key'] ); ?>" /></li>
      <li class="cf"><span class="label"><?php _e('Map design', 'tcd-canon'); ?></span><?php echo tcd_basic_radio_button($options, 'qt_access_saturation', $google_map_design_options); ?></li>
      <li class="cf"><span class="label"><?php _e('Marker type', 'tcd-canon'); ?></span><?php echo tcd_basic_radio_button($options, 'qt_gmap_marker_type', $google_map_marker_options); ?></li>
     </ul>

     <h4 class="theme_option_headline2 qt_gmap_marker_type1"><?php _e( 'Custom marker setting', 'tcd-canon' ); ?></h4>
     <ul class="option_list qt_gmap_marker_type1">
      ...
      <li class="cf qt_gmap_marker_type2"><span class="label"><?php _e('Images used for markers', 'tcd-canon'); ?><span class="recommend_desc"><?php printf(__('Recommend image size. Width:%1$spx, Height:%2$spx.', 'tcd-canon'), '60', '20'); ?></span></span><?php echo tcd_media_image_uploader($options, 'qt_gmap_marker_img', 'medium'); ?></li>
     </ul>

     <div class="theme_option_message2">
      <p><?php _e( 'In order to display Google Maps, you need to enter your API key. For details on how to obtain an API key, please see below.', 'tcd-canon' ); ?></br><a href="https://tcd-theme.com/2018/08/google-maps-platform-api.html" target="_blank" rel="noopener noreferrer"><?php _e('How to get a Google Maps Platform API key and notes', 'tcd-canon'); ?></a></p>
     </div>
