  ...
  custom_uploader[buttonId].on('select', function () { 
    ...
    attachments.each(function (attachment) {
      ...
      if (attachment.attributes.type == 'image') {
        $(button).siblings('ul').append('<li data-attechment-id="' + attachment['id'] + '"><div class="image"><img loading="lazy" class="true_pre_image" src="' + attachment.attributes.sizes.full.url + '" /></div><span class="delete-img"></span></li>');
      } else {
